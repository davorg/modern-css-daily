...
> **Correction — 1 August 2026:** The original version of this article described `scroll-timeline-position-along-axis` as a CSS feature. That was incorrect, so the erroneous article has been replaced.

The current Scroll-driven Animations specification defines `scroll-timeline`, `scroll-timeline-name`, and `scroll-timeline-axis`. It does not define a `scroll-timeline-position-along-axis` property or function.
