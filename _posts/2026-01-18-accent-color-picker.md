...
date: 2026-01-18
categories: ["CSS"]
tags: [accent-color-picker]
layout: single
---

> **Correction — 1 August 2026:** The original version of this article described `accent-color-picker` as a CSS feature. That was incorrect, so the erroneous article has been replaced.

CSS defines the [`accent-color`](https://www.w3.org/TR/css-ui-4/#widget-accent) property; it does not define a separate `accent-color-picker` property, function, selector, or media query.
