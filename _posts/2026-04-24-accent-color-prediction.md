---
title: "accent-color-prediction"
date: 2026-04-24
categories: ["CSS"]
tags: [accent-color-prediction]
layout: single
---

> **Correction — 1 August 2026:** The original version of this article described `accent-color-prediction` as a CSS feature. That was incorrect, so the erroneous article has been replaced.

CSS defines the [`accent-color`](https://www.w3.org/TR/css-ui-4/#widget-accent) property; it does not define a separate `accent-color-prediction` property, function, selector, or media query.
